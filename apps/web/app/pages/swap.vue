<template>
  <div class="p-6 max-w-2xl mx-auto">
    ...
    <div class="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg mb-6">
      ...
      <div
        v-if="apiResponse"
        class="mt-4 p-3 bg-gray-200 dark:bg-gray-700 rounded overflow-auto max-h-60"
      >
      ...
      <div
        v-if="error"
        class="mt-4 p-3 bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 rounded"
      >
        {{ error }}
      </div>
    </div>
